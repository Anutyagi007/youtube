    ...
    <div className="grid grid-flow-col p-2 m-2">
      <div className="flex col-span-1">
        <img
          ...
          className="h-6 hover:bg-gray-300 rounded-full cursor-pointer"
      ...
      <div className="col-span-10 flex justify-center flex-col">
        ...
        <input
          placeholder="Search"
          className=" h-7 px-5 w-1/2 border border-gray-300 rounded-l-full "
          type="text"
          value={searchQuery}
        ...
        />
        <button className="border border-gray-300 rounded-r-full h-7 px-3 pb-1" >
          <img
            className="h-4 px-2"
        ...
        <div className="fixed bg-white px-5 mt-[17rem] w-[34rem] shadow-lg rounded-lg">
          <ul>
      ...
      <div className="flex col-span-1 justify-center items-center">
        <img
          ...
          src="https://pixlok.com/wp-content/uploads/2021/12/Notification-Icon-SVG-03cde.png"
          alt="noti-bell"
        />
        <img
          className="h-6 mx-2 cursor-pointer"
